...
| `scythe-lint` | 24 lint rules + 35 audit rules (59 in `default_registry()`), plus 11 `SC-PRV*` and 7 `SC-DRF*` check-time rules in their own registries, sqruff integration, and the lint engine |
