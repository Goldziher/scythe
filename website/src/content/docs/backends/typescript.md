...
```typescript
// scythe:provenance v=0.15.0 backend=typescript-pg engine=postgresql schema=sch1:... queries=q1:...
...
```javascript
// scythe:provenance v=0.15.0 backend=javascript-pg engine=postgresql schema=sch1:... queries=q1:...
```
