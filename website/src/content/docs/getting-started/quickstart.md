...
```python
# scythe:provenance v=0.18.1 backend=python-psycopg3 engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582  # noqa: E501
...
```typescript
// scythe:provenance v=0.18.1 backend=typescript-pg engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
...
```go
// scythe:provenance v=0.18.1 backend=go-pgx engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
...
```java
// scythe:provenance v=0.18.1 backend=java-jdbc engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
package generated;
...
```kotlin
// scythe:provenance v=0.18.1 backend=kotlin-jdbc engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
package generated
...
```elixir
# scythe:provenance v=0.18.1 backend=elixir-postgrex engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
...
# scythe:provenance v=0.18.1 backend=ruby-pg engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
...
```php
<?php
// scythe:provenance v=0.18.1 backend=php-pdo engine=postgresql schema=sch1:2e813606acee8b51 queries=q1:9c4e1f77a0b3d582
