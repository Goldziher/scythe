...
public class IntegrationTest {
    ...
    public static void main(String[] args) throws Exception {
        String databaseUrl = System.getenv("REDSHIFT_URL");
        if (databaseUrl == null || databaseUrl.isEmpty()) {
            System.err.println("REDSHIFT_URL environment variable is required");
            System.exit(1);
        }
    ...
    private static void runMigration(Connection conn) throws Exception {
        Path schemaPath = Path.of(System.getProperty("user.dir"))
            .resolve("../sql/redshift/schema_pg_compat.sql")
            .normalize();
