// scythe:provenance v=0.15.0 backend=java-jdbc engine=redshift schema=sch1:a4457eae974a6707 queries=q1:1d594d539783fc08 options=opt1:cbf29ce484222325
package generated;
...
public static CreateUserRow createUser(Connection conn, @Nonnull String name, @Nullable String email, @Nonnull String status) throws SQLException {
