...
public class IntegrationTest {
    ...
    public static void main(String[] args) throws Exception {
        String mariadbUrl = System.getenv("MARIADB_URL");
        if (mariadbUrl == null || mariadbUrl.isEmpty()) {
            System.err.println("MARIADB_URL environment variable is required");
            System.exit(1);
        }
    ...
    private static void runMigration(Connection conn) throws Exception {
        Path schemaPath = Path.of(System.getProperty("user.dir"))
            .resolve("../sql/mariadb/schema.sql")
            .normalize();
