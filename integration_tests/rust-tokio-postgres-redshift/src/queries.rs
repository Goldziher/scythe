// scythe:provenance v=0.16.1 backend=rust-tokio-postgres engine=redshift schema=sch2:a4457eae974a6707 queries=q1:1d594d539783fc08 options=opt1:cbf29ce484222325
