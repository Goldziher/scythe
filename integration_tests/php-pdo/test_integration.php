...
{
    $user = createUser($pdo, "Alice", "alice@example.com", UserStatus::active);
...
{
    $users = listActiveUsers($pdo, UserStatus::active);
...
{
    $order = createOrder($pdo, $user_id, "49.99", "Test order");
