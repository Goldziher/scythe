// scythe:provenance v=0.16.1 backend=go-database-sql engine=mariadb schema=sch1:262bec5a0954c973 queries=q1:2f37bd0f0a685c79 options=opt1:cbf29ce484222325
package queries
