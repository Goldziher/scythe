"""Integration tests for scythe-generated psycopg3 queries with Pydantic row types."""
...
async def test_get_orders_by_user(conn: psycopg.AsyncConnection, user_id: int, order_id: int) -> None:
