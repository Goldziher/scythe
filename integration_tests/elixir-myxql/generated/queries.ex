# scythe:provenance v=0.14.0 backend=elixir-myxql engine=mysql schema=sch1:4332a9c33cb39297 queries=q1:f928696deb211f90
...
@spec create_user(MyXQL.conn(), String.t(), String.t() | nil, UsersStatus) :: :ok | {:error, term()}
