...
public static record GetOrdersByUserRow(
    int id,
    float total,
...
public static record GetOrderTotalRow(
...
public static record GetUserByIdRow(
    int id,
    String name,
...
public static record ListActiveUsersRow(
    int id,
    String name,
    @Nullable String email
) {
...
public static record SearchUsersRow(
    int id,
    String name,
    @Nullable String email
) {
