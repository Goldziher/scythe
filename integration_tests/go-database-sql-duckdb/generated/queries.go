// scythe:provenance v=0.18.1 backend=go-database-sql engine=duckdb schema=sch2:a58e9693abcdb5e7 queries=q1:3fcd9a387f9d569e options=opt1:cbf29ce484222325
package queries
