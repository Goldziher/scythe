// scythe:provenance v=0.16.0 backend=go-database-sql engine=duckdb schema=sch1:a58e9693abcdb5e7 queries=q1:3fcd9a387f9d569e options=opt1:cbf29ce484222325
package queries
