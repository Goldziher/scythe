<?php
// scythe:provenance v=0.14.0 backend=php-pdo engine=mysql schema=sch1:4332a9c33cb39297 queries=q1:f928696deb211f90
...
final class Queries {
    ...
    /**
     * @param \PDO $pdo
     * @return GetLastInsertOrderRow|null
     */
    ...
    /**
     * @param \PDO $pdo
     * @return GetLastInsertUserRow|null
     */
