...
def create_order(db, user_id, total, notes)
...
def get_order_total(db, user_id)
...
def delete_orders_by_user(db, user_id)
...
def list_active_users(db, status)
