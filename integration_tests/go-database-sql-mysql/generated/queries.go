// scythe:provenance v=0.18.1 backend=go-database-sql engine=mysql schema=sch2:4332a9c33cb39297 queries=q1:f928696deb211f90 options=opt1:cbf29ce484222325
package queries
