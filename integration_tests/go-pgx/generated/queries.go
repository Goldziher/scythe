// scythe:provenance v=0.16.1 backend=go-pgx engine=postgresql schema=sch2:c247390d575b8f71 queries=q1:b6aca93cc722fe32 options=opt1:cbf29ce484222325
...
func (v UserAddress) ToPgText() string {
	return "(" + strings.Join([]string{encodeCompositeField(v.Street), encodeCompositeField(v.City), encodeCompositeField(v.Zip)}, ",") + ")"
}
