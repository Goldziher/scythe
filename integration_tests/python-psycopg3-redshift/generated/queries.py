# scythe:provenance v=0.14.0 backend=python-psycopg3 engine=redshift schema=sch1:f882401b5f0b3b0a queries=q1:1d594d539783fc08  # noqa: E501
...
async def create_user(conn: AsyncConnection, *, name: str, email: str | None, status: str) -> CreateUserRow | None:
