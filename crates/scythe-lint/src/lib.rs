...
pub use audit::{
    AuditConfigError, MatcherFn, MatcherHit, MatcherRegistry, MatcherRule, RuleSpec,
    SuppressionSet, canonical_specs, load_rules_from_file, parse_rule_file, register_user_rules,
};
