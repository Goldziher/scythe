...
mod tests {
    ...
    #[test]
    fn test_grouped_csharp_mysqlconnector_structs() {
        let backend = crate::backends::get_backend("csharp-mysqlconnector", "mysql").unwrap();
    ...
    #[test]
    fn test_grouped_csharp_mysqlconnector_query_fn() {
        let backend = crate::backends::get_backend("csharp-mysqlconnector", "mysql").unwrap();
        let query = make_grouped_query();
        let result = crate::generate_with_backend(&query, &*backend).unwrap();
        ...
        assert!(
            query_fn.contains("MySqlConnection conn"),
