...
impl TypescriptNodeSqliteBackend {
    pub fn new(engine: &str) -> Result<Self, ScytheError> {
        ...
        let manifest =
            super::load_or_default_manifest("backends/typescript-node-sqlite/manifest.toml", DEFAULT_MANIFEST_TOML)?;
        Ok(Self {
            manifest,
    ...
    fn generate_query_fn(
        ...
        match &analyzed.command {
            ...
            QueryCommand::Many => {
                ...
                let _ = writeln!(out, "\tconst stmt = db.prepare(`{}`);", sql);
                if params.is_empty() {
                    let _ = writeln!(out, "\treturn stmt.all() as unknown as {}[];", struct_name);
                } else {
                    let _ = writeln!(
                        out,
