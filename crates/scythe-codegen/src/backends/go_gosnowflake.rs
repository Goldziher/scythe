...
pub struct GoGosnowflakeBackend {
    manifest: BackendManifest,
}

impl GoGosnowflakeBackend {
    pub fn new(engine: &str) -> Result<Self, ScytheError> {
        match engine {
            ...
            _ => {
                return Err(ScytheError::new(
                    ...
                    format!(
                        "go-gosnowflake only supports Snowflake, got engine '{}'",
                        engine
                    ),
                ));
            }
        ...
        let manifest = super::load_or_default_manifest(
            "backends/go-gosnowflake/manifest.toml",
...
impl CodegenBackend for GoGosnowflakeBackend {
    fn name(&self) -> &str {
        "go-gosnowflake"
    }
