...
const GOSNOWFLAKE_HEADER_PREAMBLE: &str = "// Code generated by scythe. DO NOT EDIT.\npackage queries";
...
mod tests {
    ...
    #[test]
    fn test_grouped_go_gosnowflake_structs() {
        let backend = get_backend("go-gosnowflake", "snowflake").unwrap();
    ...
    #[test]
    fn test_grouped_go_gosnowflake_query_fn() {
        let backend = get_backend("go-gosnowflake", "snowflake").unwrap();
        let query = make_grouped_query();
        let result = generate_with_backend(&query, &*backend).unwrap();
    ...
    /// not used".
    #[test]
    fn test_go_gosnowflake_file_header_omits_time_for_int_and_string_only_schema() {
        let backend = get_backend("go-gosnowflake", "snowflake").unwrap();
    ...
    #[test]
    fn test_go_gosnowflake_file_header_includes_time_when_columns_need_it() {
        let backend = get_backend("go-gosnowflake", "snowflake").unwrap();
        let query = make_simple_query(
            "ListOrders",
